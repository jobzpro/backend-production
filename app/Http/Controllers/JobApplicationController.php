...
class JobApplicationController extends Controller
{
    ...
    public function index(Request $request, int $id)
    {
        ...
        $applications = JobApplication::with('jobList', 'jobInterviews', 'jobList.user', 'jobList.experience_level', 'user.user_experience', 'user.account', 'user.reference')
    ...
    {
        $application = JobApplication::with('jobList', 'user', 'user.account', 'jobInterviews', 'user.reference')->find($job_application_id);
